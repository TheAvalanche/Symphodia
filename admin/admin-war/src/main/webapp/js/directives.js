...
angular.module('myApp.directives', [])
                ...
                asyncScript.load('flot', function () {
                    asyncScript.load('flot_resize', function () {
                        asyncScript.load('flot_pie', function () {
                            ...
                            $.plot($el,
                                [
                                    {label: 'Small', data: 20, color: '#5555ff'},
                                    {label: 'Medium', data: 21, color: '#5bc0de'},
                                    {label: 'Large', data: 65, color: '#428bca'}
                                ],
                                {
                                    series: {
    ...
    .directive('dropZone', ['asyncScript', 'ContextService', 'FileService', function (asyncScript, ContextService, FileService) {
        return function (scope, element, attrs) {
            scope.removeQueue = [];
            scope.addQueue = [];
